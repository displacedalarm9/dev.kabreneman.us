...
# Class: SCRIPT
# Lifecycle: Active
# Title: WorkCap Analyzer Script
# CreatedBy: Kyle Breneman
# OriginalRepo: displacedalarm9/kabreneman.us
# OriginalPath: scripts/workcap_analyzer.py
# OriginalLocation: github:displacedalarm9/kabreneman.us/scripts/workcap_analyzer.py
