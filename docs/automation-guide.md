...
Class: DOC
Lifecycle: Active
Title: Automation Guide for Work Documentation
CreatedBy: Kyle Breneman
OriginalRepo: displacedalarm9/kabreneman.us
OriginalPath: docs/automation-guide.md
OriginalLocation: github:displacedalarm9/kabreneman.us/docs/automation-guide.md
